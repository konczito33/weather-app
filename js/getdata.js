...
import { updateCoords, getCoordsData } from './coords.js'
import * as Map from './map.js'

export let actualCity
...
export async function displayActualData(data) {
  ...
  `
    ...
    sunsetSectionEl.innerHTML = `<div class="sunset__container">
            <div class="sunset__sun-c">
                ...
                <h3 class="sunset__hour sun-hour"}>${Time.sToTime(sunrise)}</h3>
            </div>
            ...
            <div class="sunset__moon-c">
                <h3 class="sunset__hour moon-hour">${Time.sToTime(sunset)}</h3>
    ...
    cityEl.addEventListener('click', async () => {
        ...
        Map.map.setView(new L.LatLng(lat, lng), 8);
        Map.showMap()
